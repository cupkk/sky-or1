...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        if save_val_stats_path is not None:
            ...
            val_stats_file = os.path.join(save_val_stats_path, f"val_stats_step_{self.global_steps}.jsonl")
            ...
            val_metrics_file = os.path.join(save_val_stats_path, "val_metrics_steps_all.jsonl")
